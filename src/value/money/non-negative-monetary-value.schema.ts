...
export const NonNegativeMonetaryValueSchema = z
  .object({
    currency: z.union([
      z.literal("XTS"),
      z.literal("AED"),
  ...
  .meta({
    ...
    examples: [
      { currency: "XTS", decimals: 4, amount: 7475005 },
      { currency: "USD", decimals: 4, amount: 0 },
      { currency: "KRW", decimals: 0, amount: 84884 },
      { currency: "XAU", decimals: -8, amount: 884 },
    ],
  });
export type NonNegativeMonetaryValue = z.infer<
  typeof NonNegativeMonetaryValueSchema
>;
