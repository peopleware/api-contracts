...
export const NegativeMonetaryValueSchema = z
  .object({
    currency: z.union([
      z.literal("XTS"),
      z.literal("AED"),
  ...
  .meta({
    ...
    examples: [{ currency: "EUR", decimals: 2, amount: -84884 }],
  });
export type NegativeMonetaryValue = z.infer<typeof NegativeMonetaryValueSchema>;
